...
import java.util.Optional;
 ...
 class SootCommandLineArguments {
    ...
    String getReachableClassesFilePath() {
         return getRequiredArgument(REACHABLE_CLASSES_FILEPATH_PARAMETER_NAME);
    }
    ...
    private void parse(final String[] args) throws ParseException {
        ...
        options.addOption(REACHABLE_CLASSES_FILEPATH_PARAMETER_NAME, true,
                "The path to the file where the reachable classes will be written (REQUIRED)");
