...
public class DefaultInterfaceTest extends AbstractTestingFramework {
  ...
  public void interfaceTest() {
    ...
    SootMethod defaultMethod =
        Scene.v().getMethod("<soot.interfaceTesting.Default: void target()>");
    ...
    SootMethod resolvedMethod =
        G.v()
            .soot_jimple_toolkits_callgraph_VirtualCalls()
  ...
  public void interfaceWithSameSignatureTest() {
    ...
    final SootMethod target =
        prepareTarget(
            methodSigFromComponents(testClass, "void", "main"),
            testClass,
            "soot.interfaceTesting.Read",
            "soot.interfaceTesting.Write");

    SootMethod mainPrintMethod =
        Scene.v().getMethod("<soot.interfaceTesting.TestInterfaceSameSignature: void print()>");
    SootMethod readInterfacePrint =
        Scene.v().getMethod("<soot.interfaceTesting.Read: void print()>");
    SootMethod writeInterfacePrint =
        Scene.v().getMethod("<soot.interfaceTesting.Write: void print()>");
    ...
    SootMethod refWritePrintMethod =
        getSootMethodRef(mainPrintBody.getUnits(), "soot.interfaceTesting.Write: void print()");
    SootMethod refReadPrintMethod =
        getSootMethodRef(mainPrintBody.getUnits(), "soot.interfaceTesting.Read: void print()");
    ...
    SootMethod resolvedMainMethod =
        G.v()
            .soot_jimple_toolkits_callgraph_VirtualCalls()
            .resolveNonSpecial(Scene.v().getRefType(testClass), mainPrintMethod.makeRef(), false);
    SootMethod resolvedWritePrintMethod =
        G.v()
            .soot_jimple_toolkits_callgraph_VirtualCalls()
            .resolveNonSpecial(
                Scene.v().getRefType(testClass), writeInterfacePrint.makeRef(), false);
    SootMethod resolvedReadPrintMethod =
        G.v()
            .soot_jimple_toolkits_callgraph_VirtualCalls()
            .resolveNonSpecial(
                Scene.v().getRefType(testClass), readInterfacePrint.makeRef(), false);
    SootMethod resolvedDefaultReadMethod =
        G.v()
            .soot_jimple_toolkits_callgraph_VirtualCalls()
            .resolveNonSpecial(Scene.v().getRefType(testClass), defaultRead.makeRef(), false);
    SootMethod resolvedDefaultWriteMethod =
        G.v()
            .soot_jimple_toolkits_callgraph_VirtualCalls()
            .resolveNonSpecial(Scene.v().getRefType(testClass), defaultWrite.makeRef(), false);

    SootMethod concreteImplMainPrint =
        Scene.v()
            .getFastHierarchy()
            .resolveConcreteDispatch(Scene.v().getSootClass(testClass), mainPrintMethod);
    SootMethod concreteImplReadPrint =
        Scene.v()
            .getFastHierarchy()
            .resolveConcreteDispatch(Scene.v().getSootClass(testClass), refReadPrintMethod);
    SootMethod concreteImplDefaultRead =
        Scene.v()
            .getFastHierarchy()
            .resolveConcreteDispatch(Scene.v().getSootClass(testClass), refDefaultRead);
    SootMethod concreteImplDefaultWrite =
        Scene.v()
            .getFastHierarchy()
            .resolveConcreteDispatch(Scene.v().getSootClass(testClass), refDefaultWrite);

    Set<SootMethod> abstractImplDefaultRead =
        Scene.v()
            .getFastHierarchy()
            .resolveAbstractDispatch(Scene.v().getSootClass(interfaceReadClass), refDefaultRead);
    Set<SootMethod> abstractImplDefaultWrite =
        Scene.v()
            .getFastHierarchy()
            .resolveAbstractDispatch(Scene.v().getSootClass(interfaceWriteClass), refDefaultWrite);
    Set<SootMethod> abstractImplReadDefaultPrint =
        Scene.v()
            .getFastHierarchy()
            .resolveAbstractDispatch(
                Scene.v().getSootClass(interfaceReadClass), refReadPrintMethod);
    Set<SootMethod> abstractImplWriteDefaultPrint =
        Scene.v()
            .getFastHierarchy()
            .resolveAbstractDispatch(
                Scene.v().getSootClass(interfaceWriteClass), refWritePrintMethod);
    ...
    assertEquals(
        ...
        Scene.v()
            .getFastHierarchy()
            .resolveConcreteDispatch(Scene.v().getSootClass(testClass), refWritePrintMethod));
  ...
  public void classInterfaceWithSameSignatureTest() {
    ...
    SootMethod mainPrintMethod =
        Scene.v()
            .getMethod("<soot.interfaceTesting.TestClassPreferenceOverInterface: void print()>");
    SootMethod defaultPrintMethod =
        Scene.v().getMethod("<soot.interfaceTesting.InterfaceOne: void print()>");
  ...
  public void superClassInterfaceWithSameSignatureTest() {
    ...
    final SootMethod target =
        prepareTarget(
            ...
            "soot.interfaceTesting.TestSuperClassImplementsInterface");

    SootMethod defaultSuperMainMethod =
        Scene.v()
            .getMethod("<soot.interfaceTesting.TestSuperClassImplementsInterface: void main()>");
    SootMethod mainMethod =
        Scene.v()
            .getMethod("<soot.interfaceTesting.TestSuperClassImplementsInterface: void print()>");
    SootMethod defaultMethod =
        Scene.v().getMethod("<soot.interfaceTesting.PrintInterface: void print()>");
    SootMethod defaultSuperClassMethod =
        Scene.v().getMethod("<soot.interfaceTesting.DefaultPrint: void print()>");
    ...
    boolean edgeSuperMainToSuperPrint =
        checkInEdges(cg, defaultSuperClassMethod, defaultSuperMainMethod);
  ...
  public void derivedInterfacesTest() {
    ...
    final SootMethod target =
        prepareTarget(
            methodSigFromComponents(testClass, "void", "main"),
            testClass,
            "soot.interfaceTesting.InterfaceTestOne",
            "soot.interfaceTesting.InterfaceTestTwo");

    SootMethod interfaceOnePrint =
        Scene.v().getMethod("<soot.interfaceTesting.InterfaceTestOne: void print()>");
    SootMethod interfaceTwoPrint =
        Scene.v().getMethod("<soot.interfaceTesting.InterfaceTestTwo: void print()>");
  ...
  public void interfaceInheritanceTest() {
    ...
    final SootMethod target =
        prepareTarget(
            methodSigFromComponents(testClass, "void", "main"),
            testClass,
            "soot.interfaceTesting.InterfaceTestA",
            "soot.interfaceTesting.InterfaceTestB");

    SootMethod interfaceTestAPrint =
        Scene.v().getMethod("<soot.interfaceTesting.InterfaceTestA: void print()>");
    SootMethod mainPrintMessageMethod =
        Scene.v()
            .getMethod("<soot.interfaceTesting.TestInterfaceInheritance: void printMessage()>");
  ...
  public void interfaceReAbstractionTest() {
    ...
    final SootMethod target =
        prepareTarget(
            methodSigFromComponents(testClass, "void", "main"),
            testClass,
            "soot.interfaceTesting.InterfaceA",
            "soot.interfaceTesting.InterfaceB");

    SootMethod interfaceAPrint =
        Scene.v().getMethod("<soot.interfaceTesting.InterfaceA: void print()>");
    SootMethod mainMethodPrint =
        Scene.v().getMethod("<soot.interfaceTesting.TestInterfaceReAbstracting: void print()>");
  ...
  public void SuperClassPreferenceOverDefaultMethodTest() {
    ...
    final SootMethod target =
        prepareTarget(
            methodSigFromComponents(testClass, "void", "main"),
            testClass,
            "soot.interfaceTesting.InterfaceOne",
            "soot.interfaceTesting.InterfaceTwo",
            "soot.interfaceTesting.TestSuperClass");

    SootMethod interfaceOnePrint =
        Scene.v().getMethod("<soot.interfaceTesting.InterfaceOne: void print()>");
    SootMethod interfaceTwoPrint =
        Scene.v().getMethod("<soot.interfaceTesting.InterfaceTwo: void print()>");
    SootMethod superClassPrint =
        Scene.v().getMethod("<soot.interfaceTesting.TestSuperClass: void print()>");
  ...
  private boolean checkInEdges(
      CallGraph callGraph, SootMethod defaultMethod, SootMethod targetMethod) {
